...
namespace RpgHeros.Heros
{
    ...
    {
        public Rogue(string name = "Rogue", byte level = 1, Weapon.WeaponTypeEnum[] validWeapons = null, Armor.ArmorTypeEnum[] validArmors = null) : base(name, level, validWeapons, validArmors)
        {
            this.name = name; // assign name to the hero
            this.level = level; // assign given level
            heroAttributes = new HeroAttributes(2, 6, 1); // assign a new HeroAttribute instance and pass values 
            this.validWeapons = new Weapon.WeaponTypeEnum[] { Weapon.WeaponTypeEnum.Dagger, Weapon.WeaponTypeEnum.Sword }; // assign a new collection of equipable weapons
        ...
        public override void LevelUp()
        {
            ...
            level++;
            heroAttributes!.UpdateAttributesEvent!.Invoke(1, 4, 1, '+');
            Console.WriteLine("\n");
